  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>MX平台的愿景</h2>
        <p>1 让每个人和家庭都可以科学去主动型管理自己一生的时间和目标 </p>
        <p>2 让所有ai模型都可以快速应用服务于最广大的群体</p>
        <p>3 最终形成社区型 城市型 私域切面型 各类型的虚拟网站</p>
        <p>4 让人类劳动者过上做三休四的工作生活</p>
        <p>
          <b>当前版本:</b> <span>v{{ version }}</span>
        </p>
        <p>
          <el-tag type="warning">mx免费开源 </el-tag>&nbsp;
          <el-tag type="danger">后端工程师：苏辰</el-tag>&nbsp;
          <el-tag type="danger">前端工程师：恩斯 </el-tag>
        </p>
        <p>
        </p>
      </el-col>
